...
- 백준 단계별 문제풀이로 시작해서 점진적으로 알고리즘 역량을 향상하고 익숙해지는 데에 목표가 있습니다.
- 알고리즘 레퍼런스 풀이 코드는 해당 단계의 풀이기간이 지난 직후 해당 저장소에 공유해드립니다.
...
- 매주 월요일 아침 8시에 해당 주에 대한 가이드 및 지난주 리뷰 진행합니다. (필참 ❌)
   - 1주차 월요일만 저녁 8시에 진행합니다. (2022.08.22 PM 08:00) (필참 ❌)
...
- 추가 문의사항 및 건의사항 편하게 디스코드 메세지 부탁드립니다.
